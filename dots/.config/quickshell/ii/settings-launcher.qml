                ...
                Loader {
                    ...
                    SequentialAnimation {
                        ...
                        ParallelAnimation {
                            ...
                            PropertyAction { target: pageLoader; property: "anchors.topMargin"; value: 20 }
                        }
                        ParallelAnimation {
                            NumberAnimation {
                                target: pageLoader; properties: "opacity"; from: 0; to: 1; duration: 200
                                easing.type: Appearance.animation.elementMoveEnter.type
                                easing.bezierCurve: Appearance.animationCurves.emphasizedLastHalf
                            }
                            NumberAnimation {
                                target: pageLoader; properties: "anchors.topMargin"; to: 0; duration: 200
                                easing.type: Appearance.animation.elementMoveEnter.type
                                easing.bezierCurve: Appearance.animationCurves.emphasizedLastHalf
                            }
                        }
