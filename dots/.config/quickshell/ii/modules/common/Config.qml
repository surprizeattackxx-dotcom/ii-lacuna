    ...
    FileView {
        ...
        JsonAdapter {
            ...
            property JsonObject apps: JsonObject {
                ...
                property string update: "kitty -1 -e arch-update --devel"
            ...
            property JsonObject bar: JsonObject {
                ...
                property list<string> screenList: [] // Auto-populated from Hyprland monitors at runtime
