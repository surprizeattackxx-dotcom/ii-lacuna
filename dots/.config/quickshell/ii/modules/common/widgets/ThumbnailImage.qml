...
StyledImage {
    ...
    property string thumbnailPath: {
        ...
        //   file:// + /path = file:///path  ← 3 slashes, CORRECT
        //   file:/// + /path = file:////path ← 4 slashes, WRONG (was the original bug)
        const encodedUrlWithoutFileProtocol = resolvedUrlWithoutFileProtocol
