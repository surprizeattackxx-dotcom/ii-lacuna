...
Variants {
    ...
    PanelWindow {
        ...
        onWallpaperPathChanged: {
            console.log(`[BG DEBUG] wallpaperPath changed on ${bgRoot.monitor?.name ?? "?"}: "${bgRoot._lastWp.substring(0,70)}" → "${bgRoot.wallpaperPath.substring(0,70)}" preview="${GlobalStates.wallpaperPreviewPath.substring(0,50)}" previewMon="${GlobalStates.wallpaperPreviewMonitor}" perMon="${bgRoot.perMonitorWallpaperPath.substring(0,50)}" cfg="${Config.options.background.wallpaperPath.substring(0,50)}"`);
            ...
            stdout: StdioCollector {
                ...
                onStreamFinished: {
                    ...
                    if (width <= screenWidth || height <= screenHeight) {
                        // Undersized: render at native size, no zoom
                        bgRoot.effectiveWallpaperScale = 1;
                    } else {
        ...
        // Reads from widgets/monitors/{monitorName}.json written by update_widget_positions.sh
            ...
            WidgetCanvas {
                ...
                FadeLoader {
                    ...
                    sourceComponent: WeatherWidget {
                        ...
                        scaledScreenHeight: bgRoot.screen.height / bgRoot.effectiveWallpaperScale
                        wallpaperScale: bgRoot.effectiveWallpaperScale
                        overrideX: bgRoot.widgetX("weather")
                        overrideY: bgRoot.widgetY("weather")
                    }
                }
                ...
                FadeLoader {
                    ...
                    sourceComponent: ClockWidget {
                        ...
                        overrideX: bgRoot.widgetX("clock")
                        overrideY: bgRoot.widgetY("clock")
                    }
                }
                ...
                FadeLoader {
                    ...
                    sourceComponent: MediaWidget {
                        ...
                        scaledScreenHeight: bgRoot.screen.height / bgRoot.effectiveWallpaperScale
                        wallpaperScale: bgRoot.effectiveWallpaperScale
                        overrideX: bgRoot.widgetX("media")
                        overrideY: bgRoot.widgetY("media")
                    }
                    onLoaded: {
