...
function getLayout(name, mx, my, mw, mh, userScale) {
    ...
    let base = {
        ...
        "battery":   { w: s(801, scale), h: s(760, scale), rx: mw - s(821, scale), ry: s(70, scale), comp: "BatteryPopup.qml" },
        ...
        "network":   { w: s(900, scale), h: s(700, scale), rx: mw - s(920, scale), ry: s(70, scale), comp: "NetworkPopup.qml" },
