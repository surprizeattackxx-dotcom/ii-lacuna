...
PanelWindow {
    ...
    Rectangle {
        ...
        // Expand for the monitor settings tab which needs more room
        width: panelStack.currentIndex === 1
        ? Math.min(1300, parent.width - 47)
        : Math.min(1000, parent.width - 47)
        height: panelStack.currentIndex === 1
        ? Math.min(820, parent.height - anchors.topMargin - 20)
        : Math.min(panelFlick.contentHeight + 48, parent.height - anchors.topMargin - 20)
        ...
        StackLayout {
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            Row {
                                spacing: 8
                                Rectangle {
                                    width: 30; height: 30; radius: 15; color: Appearance.m3colors.m3surfaceContainer
                                    Text { anchors.centerIn: parent; text: "→"; color: Appearance.colors.colOnLayer0 }
                                    MouseArea { anchors.fill: parent; cursorShape: Qt.PointingHandCursor; onClicked: panelStack.currentIndex = 1 }
                                }
                                Rectangle {
            ...
            Item {
                ...
                Rectangle {
                    ...
                    Text { anchors.centerIn: parent; text: "←"; color: Appearance.colors.colOnLayer0 }
                    MouseArea { anchors.fill: parent; cursorShape: Qt.PointingHandCursor; onClicked: panelStack.currentIndex = 0 }
                }
            }
        }
    }
