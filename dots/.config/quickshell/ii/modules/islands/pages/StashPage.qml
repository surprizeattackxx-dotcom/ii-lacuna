...
Item {
    ...
    Process {
        id: discoverProc
        command: ["bash", "-c", "exec \"$HOME/.config/quickshell/ii/modules/islands/stash/localsend_discover.sh\""]
    ...
    function sendTo(ip) {
        ...
        sendProc.command = ["bash", "-c",
            "\"$HOME/.config/quickshell/ii/modules/islands/stash/localsend_send.sh\" '" + pendingFile + "' '" + ip + "'"]
