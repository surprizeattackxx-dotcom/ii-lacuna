...
Item {
    ...
    function triggerApply() {
        ...
        if (monitorsModel.count === 1) {
            ...
            let jsonCmd = "jq '.monitors = " + safeJson + "' ~/.config/quickshell/ii/modules/islands/settings.json > ~/.config/quickshell/ii/modules/islands/settings.json.tmp && mv ~/.config/quickshell/ii/modules/islands/settings.json.tmp ~/.config/quickshell/ii/modules/islands/settings.json";
