...
Item {
    ...
    Process {
        id: musicProc
        command: ["bash", "-c", "~/.config/quickshell/ii/modules/islands/music/music_info.sh"]
                ...
                ColumnLayout {
                    ...
                    Slider {
                        ...
                        onMoved: {
                            ...
                            root.exec(`~/.config/quickshell/ii/modules/islands/music/player_control.sh seek ${value} ${root.musicData.length} "${root.musicData.playerName}"`)
                        }
                                    ...
                                    delegate: Item {
                                        ...
                                        ColumnLayout {
                                            ...
                                            Slider {
                                                ...
                                                onMoved: root.exec(`~/.config/quickshell/ii/modules/islands/music/equalizer.sh set_band ${eqBandItem.bandIndex + 1} ${value}`)
                            ...
                            Repeater {
                                ...
                                delegate: Rectangle {
                                    ...
                                    MouseArea { id: _pma; anchors.fill: parent; cursorShape: Qt.PointingHandCursor
                                        onClicked: root.exec(`~/.config/quickshell/ii/modules/islands/music/equalizer.sh preset ${modelData}`) }
                                }
                            }
                        }
                    }
