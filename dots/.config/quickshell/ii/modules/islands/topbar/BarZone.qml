...
Item {
    ...
    Component { id: activeWinComp;  ActiveWindowApplet { bar: bz.bar; barZone: bz; editMode: bz.editMode } }
    Component { id: sysmonComp;     SysMonApplet       { bar: bz.bar; barZone: bz; editMode: bz.editMode } }
    Component { id: weatherComp;    WeatherApplet      { bar: bz.bar; barZone: bz; editMode: bz.editMode } }
    Component { id: updatesComp;    UpdatesApplet      { bar: bz.bar; barZone: bz; editMode: bz.editMode } }
    Component { id: netspeedComp;   NetSpeedApplet     { bar: bz.bar; barZone: bz; editMode: bz.editMode } }
    Component { id: localsendComp;  LocalSendApplet    { bar: bz.bar; barZone: bz; editMode: bz.editMode } }
    Component { id: policiesComp;   PoliciesApplet     { bar: bz.bar; barZone: bz; editMode: bz.editMode } }
    Component { id: dashboardComp;  DashboardApplet    { bar: bz.bar; barZone: bz; editMode: bz.editMode } }
    Component { id: utilsComp;      UtilsApplet        { bar: bz.bar; barZone: bz; editMode: bz.editMode } }
    ...
    readonly property var appletDefs: [
        ...
        { id: "activewin", comp: activeWinComp, label: "Active Window", icon: "󱂬" },
        { id: "sysmon",    comp: sysmonComp,    label: "System Monitor", icon: "" },
        { id: "weather",   comp: weatherComp,   label: "Weather",   icon: "󰖐" },
        { id: "updates",   comp: updatesComp,   label: "Updates",   icon: "󰚰" },
        { id: "netspeed",  comp: netspeedComp,  label: "Net Speed", icon: "󰓅" },
        { id: "localsend", comp: localsendComp, label: "LocalSend", icon: "󰒢" },
        { id: "policies",  comp: policiesComp,  label: "Left Panel", icon: "󰍜" },
        { id: "dash",      comp: dashboardComp, label: "Dashboard", icon: "󰕮" },
        { id: "utils",     comp: utilsComp,     label: "Utilities", icon: "󰦬" },
    ]
