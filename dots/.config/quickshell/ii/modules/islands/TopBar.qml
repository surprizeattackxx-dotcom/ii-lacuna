...
Variants {
    ...
    delegate: Component {
        PanelWindow {
            ...
            Process {
                id: settingsReader
                command: ["bash", "-c", "cat ~/.config/quickshell/ii/modules/islands/settings.json 2>/dev/null || echo '{}'"]
                running: true
            ...
            Process {
                id: settingsWatcher
                command: ["bash", "-c", "while [ ! -f ~/.config/quickshell/ii/modules/islands/settings.json ]; do sleep 1; done; inotifywait -qq -e modify,close_write ~/.config/quickshell/ii/modules/islands/settings.json"]
                running: true
                stdout: StdioCollector {
                    onStreamFinished: {
            ...
            Process {
                id: wsDaemon
                command: ["bash", "-c", "~/.config/quickshell/ii/modules/islands/workspaces.sh"]
                running: true
            }
                            ...
                            try {
                                ...
                                if (workspacesModel.count !== newData.length) {
                                    ...
                                    for (let i = 0; i < newData.length; i++) {
                                        ...
                                        if (workspacesModel.get(i).wsMonitor !== (newData[i].monitor || "")) {
                                            workspacesModel.setProperty(i, "wsMonitor", newData[i].monitor || "");
                                        }
                                    }
                                }
                            } catch (e) {
            ...
            Process {
                ...
                running: true
                command: ["bash", "-c", "bash ~/.config/quickshell/ii/modules/islands/music/music_info.sh | tee /tmp/music_info.json"]
                stdout: StdioCollector {
                    onStreamFinished: {
                        let txt = this.text.trim();
                        if (txt !== "") {
            ...
            Process {
                id: kbPoller
                running: true
                command: ["bash", "-c", "~/.config/quickshell/ii/modules/islands/watchers/kb_fetch.sh"]
                stdout: StdioCollector {
                    onStreamFinished: {
                        let txt = this.text.trim();
            ...
            Process {
                id: kbWaiter
                command: ["bash", "-c", "~/.config/quickshell/ii/modules/islands/watchers/kb_wait.sh"]
            ...
            Process {
                id: audioPoller
                running: true
                command: ["bash", "-c", "~/.config/quickshell/ii/modules/islands/watchers/audio_fetch.sh"]
                stdout: StdioCollector {
                    onStreamFinished: {
                        let txt = this.text.trim();
                        if (txt !== "") {
            ...
            Process {
                id: audioWaiter
                command: ["bash", "-c", "~/.config/quickshell/ii/modules/islands/watchers/audio_wait.sh"]
            ...
            Process {
                id: networkPoller
                running: true
                command: ["bash", "-c", "~/.config/quickshell/ii/modules/islands/watchers/network_fetch.sh"]
                stdout: StdioCollector {
                    onStreamFinished: {
                        let txt = this.text.trim();
                        if (txt !== "") {
            ...
            Process {
                id: networkWaiter
                command: ["bash", "-c", "~/.config/quickshell/ii/modules/islands/watchers/network_wait.sh"]
            ...
            Process {
                id: btPoller
                running: true
                command: ["bash", "-c", "~/.config/quickshell/ii/modules/islands/watchers/bt_fetch.sh"]
                stdout: StdioCollector {
                    onStreamFinished: {
                        let txt = this.text.trim();
                        if (txt !== "") {
            ...
            Process {
                id: btWaiter
                command: ["bash", "-c", "~/.config/quickshell/ii/modules/islands/watchers/bt_wait.sh"]
            ...
            Process {
                id: batteryPoller
                running: true
                command: ["bash", "-c", "~/.config/quickshell/ii/modules/islands/watchers/battery_fetch.sh"]
                stdout: StdioCollector {
                    onStreamFinished: {
                        let txt = this.text.trim();
                        if (txt !== "") {
            ...
            Process {
                id: batteryWaiter
                command: ["bash", "-c", "~/.config/quickshell/ii/modules/islands/watchers/battery_wait.sh"]
            ...
            Process {
                id: pulsePoller
                running: true
                command: ["bash", "-c", "~/.config/quickshell/ii/modules/islands/watchers/pulse_fetch.sh"]
                stdout: StdioCollector {
                    onStreamFinished: {
                        let txt = this.text.trim();
                        if (txt !== "") {
            ...
            Process {
                id: pulseWaiter
                command: ["bash", "-c", "~/.config/quickshell/ii/modules/islands/watchers/pulse_wait.sh"]
