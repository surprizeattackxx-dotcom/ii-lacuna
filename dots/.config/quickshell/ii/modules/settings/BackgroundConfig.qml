...
ContentPage {
    ...
    forceWidth: true
        ...
        ContentSection {
            icon: "auto_awesome"
            title: Translation.tr("Smart scheme detection")
            tooltip: Translation.tr("Colorfulness and brightness thresholds used when auto-detecting the Material You scheme from your wallpaper. Lower t1/t2 = more images get monochrome/neutral schemes.")

            ConfigSlider {
                text: Translation.tr("Monochrome threshold (t1)")
                buttonIcon: "contrast"
                textWidth: 200
                usePercentTooltip: false
                from: 0; to: 80
                stopIndicatorValues: [20]
                value: Config.options.appearance?.wallpaperTheming?.schemeThresholds?.t1 ?? 20
                onValueChanged: {
                    Config.options.appearance.wallpaperTheming.schemeThresholds.t1 = value
                }
            }
            ConfigSlider {
                text: Translation.tr("Neutral threshold (t2)")
                buttonIcon: "gradient"
                textWidth: 200
                usePercentTooltip: false
                from: 0; to: 120
                stopIndicatorValues: [40]
                value: Config.options.appearance?.wallpaperTheming?.schemeThresholds?.t2 ?? 40
                onValueChanged: {
                    Config.options.appearance.wallpaperTheming.schemeThresholds.t2 = value
                }
            }
            ConfigSlider {
                text: Translation.tr("Tonal spot threshold (t3)")
                buttonIcon: "palette"
                textWidth: 200
                usePercentTooltip: false
                from: 0; to: 160
                stopIndicatorValues: [70]
                value: Config.options.appearance?.wallpaperTheming?.schemeThresholds?.t3 ?? 70
                onValueChanged: {
                    Config.options.appearance.wallpaperTheming.schemeThresholds.t3 = value
                }
            }
            ConfigSlider {
                text: Translation.tr("Vivid threshold (t4)")
                buttonIcon: "flare"
                textWidth: 200
                usePercentTooltip: false
                from: 0; to: 250
                stopIndicatorValues: [100]
                value: Config.options.appearance?.wallpaperTheming?.schemeThresholds?.t4 ?? 100
                onValueChanged: {
                    Config.options.appearance.wallpaperTheming.schemeThresholds.t4 = value
                }
            }
            ConfigSlider {
                text: Translation.tr("Brightness midpoint")
                buttonIcon: "brightness_6"
                textWidth: 200
                usePercentTooltip: false
                from: 0; to: 255
                stopIndicatorValues: [128]
                value: Config.options.appearance?.wallpaperTheming?.schemeThresholds?.brightnessMid ?? 128
                onValueChanged: {
                    Config.options.appearance.wallpaperTheming.schemeThresholds.brightnessMid = value
                }
            }
        }
}
