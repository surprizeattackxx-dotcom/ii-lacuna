...
hl.bind("SUPER + CTRL + R", hl.dsp.exec_cmd("~/.config/hypr/scripts/reload.sh"))
...
hl.bind("SUPER + W", hl.dsp.exec_cmd("qs -c ii ipc call wallpaperChanger toggle"))
...
hl.bind("SUPER + SHIFT + I", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call ai toggle"))
...
hl.bind("SUPER + SHIFT + S", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call region screenshot"))
hl.bind("SUPER + SHIFT + A", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call region search"))
hl.bind("SUPER + SHIFT + X", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call region ocr"))
...
-- Simulate mouse left-click DOWN when pressing Right CTRL
hl.bind("Control_R", hl.dsp.exec_cmd("ydotool click 0xC0"))

-- Simulate mouse left-click UP when releasing Right CTRL
hl.bind("Control_R", hl.dsp.exec_cmd("ydotool click 0x40"), { release = true })
