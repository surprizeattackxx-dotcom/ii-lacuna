-- diablo-1.lua — Diablo-style vertical slide animations (variant 1)
-- NOTE: snappyReturn and bounce were identical curves in the original — kept bounce, snappyReturn removed
...
hl.animation({ leaf = "windows",      enabled = true, speed = 5,  bezier = "bounce", style = "slidevert" })
hl.animation({ leaf = "windowsIn",    enabled = true, speed = 5,  bezier = "bounce", style = "slidevert right" })
hl.animation({ leaf = "windowsOut",   enabled = true, speed = 5,  bezier = "bounce", style = "slide" })
