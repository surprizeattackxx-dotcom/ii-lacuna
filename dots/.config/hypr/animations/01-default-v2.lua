-- 01-default-v2.lua — Default v2 animation preset
...
hl.animation({ leaf = "borderangle", enabled = true, speed = 10, bezier = "linear", style = "once" }) -- used by rainbow borders and rotating colors
