...
hl.window_rule({ name = "ws-discord",    match = { class = "^(discord)$" },            workspace = 11 })
hl.window_rule({ name = "ws-thunderbird", match = { class = "^(org\\.mozilla\\.Thunderbird)$" }, workspace = 5 })
hl.window_rule({ name = "ws-spotify",    match = { class = "^(Spotify)$" },           workspace = 8 })
hl.window_rule({ name = "ws-gimp",       match = { class = "^(Gimp-2.10)$" },         workspace = 9 })
hl.window_rule({ name = "float-media",   match = { class = "^(mpv|imv|vlc)$" },       float = true, center = true })
hl.window_rule({ name = "steam-sub",     match = { class = "^(steam)$", title = "^((?!Steam$).*)$" }, center = true })
